...
#define ID_SPRITE_KOOPA 1000
#define ID_SPRITE_KOOPA_WALK_LEFT (ID_SPRITE_KOOPA+10)
#define ID_SPRITE_KOOPA_WALK_RIGHT (ID_SPRITE_KOOPA+15)
#define ID_SPRITE_KOOPA_DIE (ID_SPRITE_KOOPA+20)
#define ID_SPRITE_KOOPA_SHELL_IDLE (ID_SPRITE_KOOPA+30)
#define ID_SPRITE_KOOPA_SHELL_MOVING (ID_SPRITE_KOOPA+40)
#define ID_SPRITE_KOOPA_SHELL_FLICKERING (ID_SPRITE_KOOPA+50)
#define ID_SPRITE_KOOPA_WING (ID_SPRITE_KOOPA+60)
